...
// 1. ADD `initialData` AS A PROP HERE
export default function BundleSetupUI({ initialData }) {
  
  // 2. SET STATES TO USE SAVED DATA IF IT EXISTS
  ...
  return (
    <BlockStack gap="500">
      ...
      {/* This packages all our dynamic state into a JSON string for the backend */}
